...
public class ModuleController(IUnitOfWork unitOfWork) : ControllerBase
{
    ...
    public async Task<IActionResult> List()
    {
        try
        {
            var data = await _unitOfWork.SP_Call.List<RegisterModuleView>("AdModuleGetAll");
    ...
    public async Task<IActionResult> Details(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.OneRecord<RegisterModuleView>("AdModuleGetById", parameter);
    ...
    [HttpPost("create")]
    public async Task<IActionResult> Create([FromBody] RegisterModule model)
    {
    ...
    [HttpPost("update")]
    public async Task<IActionResult> Update([FromBody] RegisterModuleView model)
    {
        if (!ModelState.IsValid)
            return BadRequest(SD.Message_Model_Error);
