...
public static class SD
{
    ...
    public const string BirthdayImageUrl = "https://umug.umoja-international.com/eimages/birthday.jpg";
    ...
    public const string Message_PasswordExpired = "Password Expired";
    public const string Message_NotFound = "We could not find what you were looking for!";
    ...
    public const string Key = "YourSecretKey123456";
    
    public const int PasswordExpireDays = 20;
}
