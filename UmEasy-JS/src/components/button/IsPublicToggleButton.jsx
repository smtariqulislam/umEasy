...
const IsPublicToggleButton = ({ path, action, isPublic }) => {
  ...
  return (
    <>
      <button
        className={`${
          isPublic === 0 ? "btn-danger w-20 h-10" : "btn-success w-20 h-10 "
        } `}
        onClick={() => {
          openModal();
        }}
      ...
      <DialogBody
        ...
        isOpen={isOpen}
        onSubmit={onSubmit}
        bodyText={`Are you sure you want to make it ${
          isPublic === 0 ? "Public" : "Private"
